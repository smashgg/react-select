...
class Select extends React.Component {
    ...
    static propTypes = {
		...
		closeMenuOnClick: PropTypes.bool,     // Whether selecting a value closes option menu. ATM only makes a difference for !multi
    ...
    static Async = Async;
    static AsyncCreatable = AsyncCreatable;
