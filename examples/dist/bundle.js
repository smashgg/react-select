...
},{"./lib/ReactPropTypesSecret":12}],9:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./checkPropTypes":8,"./lib/ReactPropTypesSecret":12,"object-assign":7}],11:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
var propTypes = {
	multi: _propTypes2['default'].bool.isRequired, // determines if you can have multiple values
		...
		value: function render() {
			...
			var props = {
				...
				onChange: function onChange(newValues) {
					if (_this3.props.value && !_this3.props.multi && newValues.length > _this3.props.value.length) {
						_this3.clearOptions();
					}
...
},{"./Select":"react-select","./utils/stripDiacritics":21,"prop-types":11,"react":undefined}],14:[function(require,module,exports){
'use strict';
...
},{"./Select":"react-select","create-react-class":2,"react":undefined}],15:[function(require,module,exports){
'use strict';
...
},{"./Select":"react-select","./utils/defaultFilterOptions":19,"./utils/defaultMenuRenderer":20,"create-react-class":2,"prop-types":11,"react":undefined}],16:[function(require,module,exports){
'use strict';
...
},{"classnames":undefined,"create-react-class":2,"prop-types":11,"react":undefined}],17:[function(require,module,exports){
'use strict';
...
},{"./stripDiacritics":21}],20:[function(require,module,exports){
'use strict';
...
},{"classnames":undefined,"react":undefined}],21:[function(require,module,exports){
'use strict';
...
var Select = (0, _createReactClass2['default'])({
	...
	propTypes: {
		...
		closeMenuOnClick: _propTypes2['default'].bool, // Whether selecting a value closes option menu. ATM only makes a difference for !multi
	...
	renderValue: function renderValue(valueArray, isOpen) {
		...
		if (this.props.multi) {
			return valueArray.map(function (value, i) {
				var renderedValue = renderLabel(value, i);
				if (!renderedValue) {
					return null;
				}
				return _react2['default'].createElement(
			...
			var renderedValue = renderLabel(valueArray[0]);
			if (!renderedValue) {
				return null;
			}
...
},{"./Async":13,"./AsyncCreatable":14,"./Creatable":15,"./Option":16,"./Value":17,"./utils/defaultArrowRenderer":18,"./utils/defaultFilterOptions":19,"./utils/defaultMenuRenderer":20,"classnames":undefined,"create-react-class":2,"prop-types":11,"react":undefined,"react-dom":undefined,"react-input-autosize":undefined}]},{},[]);
